@extends('layouts.admin', ['header' => 'Додати категорію'])
                        ...
                        <div class="tab-pane fade show active" id="v-pills-uk" role="tabpanel"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="seo_description_uk" class="form-control" rows="6"
                                          name="seo_description_uk">{{ old('seo_description_uk') }}</textarea>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="fields" name="fields[]" class="form-select js-select2-fields" multiple
                            ...
                            @foreach($fields as $field)
                                <option value="{{ $field->id }}" @if(old('fields') && in_array($field->id, old('fields'))) selected @endif>{{ $field->title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
